      ...
      <div className="p-4 space-y-4">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-sm text-muted-foreground mt-1">Time window: {data.timeWindow}</p>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardHeader className="pb-2">
            <CardTitle className="text-sm text-muted-foreground">Related Metrics</CardTitle>
          </CardHeader>
        ...
        <Card>
          <CardHeader className="pb-2">
            <CardTitle className="text-sm text-muted-foreground">Historical Trend</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="h-48">
              <MetricLineChart title="" metricKey={data.metricId} unit={data.unit} compact={true} />
            </div>
          </CardContent>
        </Card>
