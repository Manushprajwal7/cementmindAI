...
export function ReportSharing({ reports }: ReportSharingProps) {
  ...
  const handleShareReport = () => {
    const newShare: SharedReport = {
      ...
      reportName:
        reports.find((r) => r.id === shareForm.reportId)?.name ||
        "Unknown Report",
      ...
      expiresAt: new Date(
        Date.now() + Number.parseInt(shareForm.expiresIn) * 24 * 60 * 60 * 1000
      ),
      shareLink: `https://reports.company.com/shared/${Math.random()
        .toString(36)
        .substr(2, 9)}`,
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-green-600">
                  {sharedReports.reduce(
                    (sum, report) => sum + report.sharedWith.length,
                    0
                  )}
                </p>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-purple-600">
                  {sharedReports.reduce(
                    (sum, report) => sum + report.accessCount,
                    0
                  )}
                </p>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-orange-600">
                  {sharedReports.filter((r) => r.isPublic).length}
                </p>
              </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4 text-sm">
                      <div>
                        ...
                        <p className="font-medium">
                          {share.sharedWith.length} recipients
                        </p>
                      </div>
                      <div>
                      ...
                      {share.lastAccessed && (
                        <div>
                          ...
                          <p className="font-medium">
                            {share.lastAccessed.toLocaleString()}
                          </p>
                        </div>
                      )}
                    </div>
        ...
        <TabsContent value="share" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Share a report with team members or external stakeholders
              </CardDescription>
            </CardHeader>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <Select
                      ...
                      onValueChange={(value) =>
                        setShareForm((prev) => ({ ...prev, reportId: value }))
                      }
                    >
                      <SelectTrigger>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Report access patterns over time
                </CardDescription>
              </CardHeader>
              <CardContent>
                      ...
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-xs text-muted-foreground">
                              {report.sharedWith.length} recipients
                            </p>
                          </div>
                        </div>
